...
local user_opts = {
	...
	showfullscreen = false, -- show OSC when fullscreen?
...
local osc_styles = {
	TransBg = "{\\blur60\\bord53\\1c&HFF0000&\\3c&H000000&}",
	...
	Title = "{\\blur1\\bord0.5\\1c&HFFFFFF&\\3c&H0\\fs40\\q2\\fn" .. user_opts.font .. "}",
